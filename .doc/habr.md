...
6. Стремиться в 100% test coverage дело крайне полезное, особенно если пишешь решение на базе другого.
...
8. Сторонние библиотеки могут работать непредсказуемо и значительно изменяться на минорных версиях (и плевать им на [semver](https://semver.org/)).
...
Разработка данной библиотеки с учетом реализации, автотестов, документации, примеров и данной статьи заняло примерно 2 месяца чистого рабочего времени. И это определенно не предел, так как продут будет в дальнейшем развиваться в силу моей сферы деятельности и позиции.   
Из глобальных планов - добавить конвертер для xml и protobuf, продумать удобную работу с SOUP конвертом.   
