...
import org.touchbit.retrofit.ext.dmr.client.JacksonDualConverterFactoryClient;
...
import org.touchbit.retrofit.ext.dmr.client.jackson.ErrDTO;
import org.touchbit.retrofit.ext.dmr.client.jackson.SucDTO;
...
public class JacksonDualConverterFactoryClientFuncTests extends BaseUnitTest {
    ...
    private static final JacksonDualConverterFactoryClient CLIENT = DualResponseRetrofitClientUtils
            .create(JacksonDualConverterFactoryClient.class,
                    "http://localhost",
                    new LoggedMockInterceptor(),
                    new DualResponseCallAdapterFactory(),
                    new JacksonDualConverterFactory());
    ...
    public class ReturnConversionTests {
        ...
        public void test1639150463762() {
            assertThrow(() -> CLIENT.returnListJacksonModel(OK, BLANK_STRING))
                    ...
                    .assertMessageIs("\n" +
                            ...
                            "java.util.List<org.touchbit.retrofit.ext.dmr.client.jackson.SucDTO>\n" +
                            "Cannot deserialize instance of " +
                            "`java.util.ArrayList<org.touchbit.retrofit.ext.dmr.client.jackson.SucDTO>` " +
        ...
        @Test
        @DisplayName("List<SucDTO>: return null if body is empty (content-length=0)")
        public void test1639150478899() {
            CLIENT.returnListJacksonModel(OK, EMPTY_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("List: return empty List if body = []")
        ...
        @Test
        @DisplayName("Boolean: return null if body = <blank string>")
        public void test1639065953569() {
            CLIENT.returnBoolean(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("Byte: return null if body = <blank string>")
        public void test1639065953603() {
            CLIENT.returnByte(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("Integer: return null if body = <blank string>")
        public void test1639065953637() {
            CLIENT.returnInteger(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("Double: return null if body = '    ' (blank string)")
        public void test1639065953671() {
            CLIENT.returnDouble(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("Float: return null if body = '    ' (blank string)")
        public void test1639065953705() {
            CLIENT.returnFloat(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("Long: return null if body = '    ' (blank string)")
        public void test1639065953739() {
            CLIENT.returnLong(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
        ...
        @Test
        @DisplayName("Short: return null if body = '    ' (blank string)")
        public void test1639065953773() {
            CLIENT.returnShort(OK, BLANK_STRING).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
