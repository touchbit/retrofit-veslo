...
package org.touchbit.retrofit.veslo;
...
import static org.touchbit.retrofit.veslo.client.converter.api.ExtensionConverter.NULL_BODY_VALUE;

@DisplayName("JacksonDualConverterFactory.class functional tests")
public class JacksonConverterFactoryClientFuncTests extends BaseUnitTest {
    ...
    public class ReturnConversionTests {
        ...
        public void test1639150463762() {
            assertThrow(() -> CLIENT.returnListJacksonModel(OK, BLANK_STRING))
                    ...
                    .assertMessageIs("\n" +
                            ...
                            "java.util.List<org.touchbit.retrofit.veslo.client.jackson.SucDTO>\n" +
                            "Cannot deserialize instance of " +
                            "`java.util.ArrayList<org.touchbit.retrofit.veslo.client.jackson.SucDTO>` " +
        ...
        public void test1639150478899() {
            CLIENT.returnListJacksonModel(OK, NULL_BODY_VALUE).assertResponse(asserter -> asserter
                    .assertHttpStatusCodeIs(OK)
                    .assertSucBodyIsNull()
                    .assertErrBodyIsNull());
        }
