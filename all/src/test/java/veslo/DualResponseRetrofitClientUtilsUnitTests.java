...
import veslo.client.inteceptor.ResponseInterceptAction;

import java.util.List;

import static org.hamcrest.Matchers.*;
import static veslo.DualResponseRetrofitClientUtils.*;
...
public class DualResponseRetrofitClientUtilsUnitTests extends BaseUnitTest {
    ...
    private static final GsonConverterFactory G_FACTORY = new GsonConverterFactory();
    private static final Class<? extends GsonConverterFactory> G_FACTORY_CLASS = G_FACTORY.getClass();
