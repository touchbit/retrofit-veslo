...
import veslo.client.JacksonDualConverterFactoryClient;
import veslo.client.LoggedMockInterceptor;
import veslo.client.adapter.UniversalCallAdapterFactory;
import veslo.client.jackson.ErrDTO;
import veslo.client.jackson.SucDTO;
...
public class JacksonConverterFactoryClientFuncTests extends BaseFuncTest {
    ...
    private static final JacksonDualConverterFactoryClient CLIENT = buildClient(
            JacksonDualConverterFactoryClient.class,
