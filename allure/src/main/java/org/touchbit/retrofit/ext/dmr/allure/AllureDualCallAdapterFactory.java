...
import org.touchbit.retrofit.ext.dmr.client.adapter.IDualResponseConsumer;
 ...
 */
public class AllureDualCallAdapterFactory extends DualCallAdapterFactory {

    public AllureDualCallAdapterFactory() {
        super();
    }

    public AllureDualCallAdapterFactory(IDualResponseConsumer<IDualResponse<?, ?>> consumer) {
        super(consumer);
    }

    public AllureDualCallAdapterFactory(Logger logger) {
        super(logger);
    }

    public AllureDualCallAdapterFactory(Logger logger, IDualResponseConsumer<IDualResponse<?, ?>> consumer) {
