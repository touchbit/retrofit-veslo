...
public class AllureDualCallAdapterFactoryUnitTests extends BaseUnitTests {

    @Test
    @DisplayName("AllureDualCallAdapterFactory constructors")
    public void test1638356144540() {
        new AllureDualCallAdapterFactory();
        new AllureDualCallAdapterFactory(DualResponse::new);
        new AllureDualCallAdapterFactory(LoggerFactory.getLogger("test1638356144540"));
        new AllureDualCallAdapterFactory(LoggerFactory.getLogger("test1638356144540"), DualResponse::new);
    }

    @Test
    @DisplayName("#getEndpointInfo() return empty string if Description.value = ''")
    public void test1638356312885() {
        final Annotation[] array = array(getDescription(""));
        final String endpointInfo = new AllureDualCallAdapterFactory().getEndpointInfo(array);
        assertThat("", endpointInfo, emptyString());
    }

    @Test
    @DisplayName("#getEndpointInfo() return empty string if Description.value = '   '")
    public void test1638356406896() {
        final Annotation[] array = array(getDescription("   "));
        final String endpointInfo = new AllureDualCallAdapterFactory().getEndpointInfo(array);
        assertThat("", endpointInfo, emptyString());
    }
    ...
    public void test1638356893317() {
        assertThrow(() -> new AllureDualCallAdapterFactory().getEndpointInfo(null)).assertNPE("methodAnnotations");
    }

    @Test
    @DisplayName("#getCallAdapter() all parameters are required")
    public void test1638356969657() {
        ...
        final AllureDualCallAdapterFactory factory = new AllureDualCallAdapterFactory();
        ...
        assertThrow(() -> factory.getCallAdapter(type, oc, oc, null, array(), retrofit)).assertNPE("stepInfo");
    ...
    public void test1638357437756() throws IOException {
        final ParameterizedType type = mock(ParameterizedType.class);
        final Retrofit retrofit = mock(Retrofit.class);
        final Class<Object> oc = Object.class;
        final AllureDualCallAdapterFactory factory = new AllureDualCallAdapterFactory();
    ...
    public void test1638357523314() throws IOException {
        final ParameterizedType type = mock(ParameterizedType.class);
        final Retrofit retrofit = mock(Retrofit.class);
        final Class<Object> oc = Object.class;
        final AllureDualCallAdapterFactory factory = new AllureDualCallAdapterFactory();
    ...
    public void test1638358094530() throws IOException {
        final ParameterizedType type = mock(ParameterizedType.class);
        final Retrofit retrofit = mock(Retrofit.class);
        final Class<Object> oc = Object.class;
        final AllureDualCallAdapterFactory factory = new AllureDualCallAdapterFactory();
