...
import org.touchbit.retrofit.veslo.allure.testutil.UnitTestInternalAllurePlatform;
...
public class AllureDualResponseCallAdapterFactoryUnitTests extends BaseUnitTests {

    @Test
    @DisplayName("AllureDualCallAdapterFactory constructors")
    public void test1639065952668() {
        new AllureDualResponseCallAdapterFactory();
        new AllureDualResponseCallAdapterFactory(DualResponse::new);
        new AllureDualResponseCallAdapterFactory(LoggerFactory.getLogger("test1638356144540"));
        new AllureDualResponseCallAdapterFactory(LoggerFactory.getLogger("test1638356144540"), DualResponse::new);
    }
    ...
    public void test1639065952677() {
        ...
        final String endpointInfo = new AllureDualResponseCallAdapterFactory().getEndpointInfo(array);
    ...
    public void test1639065952709() {
        assertThrow(() -> new AllureDualResponseCallAdapterFactory().getEndpointInfo(null)).assertNPE("methodAnnotations");
    }
    ...
    public void test1639065952715() {
        ...
        final AllureDualResponseCallAdapterFactory factory = new AllureDualResponseCallAdapterFactory();
