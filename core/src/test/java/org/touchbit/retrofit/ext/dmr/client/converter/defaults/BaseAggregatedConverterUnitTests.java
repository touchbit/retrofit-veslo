...
import org.touchbit.retrofit.ext.dmr.client.converter.typed.BooleanConverter;
import org.touchbit.retrofit.ext.dmr.client.converter.typed.IntegerConverter;
import org.touchbit.retrofit.ext.dmr.client.converter.typed.StringConverter;
        ...
        public void test1639680932478() {
            ...
            assertThrow(() -> converter.requestBodyConverter(Boolean.class, AA, AA, RTF))
                    ...
                    .assertMessageContains("Unsupported type for converter " +
                            "org.touchbit.retrofit.ext.dmr.client.converter.defaults.BaseAggregatedConverterUnitTests$1\n" +
