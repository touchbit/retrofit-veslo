...
public class JavaReferenceTypeConverterUnitTests extends BaseUnitTest {
    ...
    public void test1639677313953() {
        ...
        assertThat(converter.getConverterForType(Character.class), is(CharacterConverter.INSTANCE));
        assertThat(converter.getConverterForType(Boolean.class), is(BooleanConverter.INSTANCE));
        assertThat(converter.getConverterForType(Byte.class), is(ByteConverter.INSTANCE));
        assertThat(converter.getConverterForType(Integer.class), is(IntegerConverter.INSTANCE));
        assertThat(converter.getConverterForType(Double.class), is(DoubleConverter.INSTANCE));
