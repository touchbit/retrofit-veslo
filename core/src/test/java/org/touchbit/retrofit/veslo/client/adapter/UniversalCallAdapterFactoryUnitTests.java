...
public class UniversalCallAdapterFactoryUnitTests extends BaseCoreUnitTest {
    ...
    private static final UniversalCallAdapterFactory FACTORY = new UniversalCallAdapterFactory();
    ...
    public class ConstructorTests {
        ...
        public void test1639236659356() {
            assertNPE(() -> new UniversalCallAdapterFactory(null, DualResponse::new), "logger");
            assertNPE(() -> new UniversalCallAdapterFactory(UNIT_TEST_LOGGER, null), "dualResponseConsumer");
        }
        ...
        public void test1639237203780() {
            ...
            final UniversalCallAdapterFactory factory = new UniversalCallAdapterFactory(consumer);
            assertThat(factory.getDualResponseConsumer(), Matchers.is(consumer));
            assertThat(factory.logger, notNullValue());
        }
        ...
        public void test1639237301104() {
            final IDualResponseConsumer<IDualResponse<?, ?>> consumer = UnitDualResponseTest::new;
            final UniversalCallAdapterFactory factory = new UniversalCallAdapterFactory(UNIT_TEST_LOGGER, consumer);
            assertThat(factory.getDualResponseConsumer(), Matchers.is(consumer));
            assertThat(factory.logger, is(UNIT_TEST_LOGGER));
        }
    ...
    public class GetMethodTests {
        ...
        public void test1639065951487() {
            final CallAdapter<?, ?> adapter = FACTORY.get(DUAL_RESPONSE_GENERIC_STRING_TYPE, AA, RETROFIT);
            assertThat("", adapter, notNullValue());
            assertThat("", adapter.responseType(), instanceOf(ParameterizedType.class));
            final Call call = RetrofitTestUtils.getCall(200, "");
            final IDualResponse response = (IDualResponse) adapter.adapt(call);
    ...
    public class GetCallAdapterMethodTests {
        ...
        public void test1639236352471() {
            final ParameterizedType type = FACTORY.getParameterizedType(DUAL_RESPONSE_GENERIC_STRING_TYPE);
            final Call call = RetrofitTestUtils.getCall(200, "");
            final Object object = FACTORY.getCallAdapter(type, STRING_C, STRING_C, "", AA, RETROFIT)
                    .adapt(call);
            final String info = ((IDualResponse) object).getEndpointInfo();
        ...
        public void test1639236506503() {
            final ParameterizedType type = FACTORY.getParameterizedType(DUAL_RESPONSE_GENERIC_STRING_TYPE);
            final Call call = RetrofitTestUtils.getCall(200, "");
            final Object object = FACTORY.getCallAdapter(type, STRING_C, STRING_C, " test1639236506503 ", AA, RETROFIT)
                    .adapt(call);
            final String info = ((IDualResponse) object).getEndpointInfo();
    ...
    public class GetIDualResponseMethodTests {
        ...
        public void test1639065951507() {
            final Call call = RetrofitTestUtils.getCall(200, "");
            final IDualResponse iDualResponse = new UniversalCallAdapterFactory(UnitDualResponseTest::new)
        ...
        public void test1639065951578() {
            assertThrow(() -> FACTORY.getParameterizedType(DUAL_RESPONSE_RAW_TYPE))
                    ...
                    .assertMessageIs("API method must return generic type of IDualResponse<SUC_DTO, ERR_DTO>\n" +
                            "Actual: class org.touchbit.retrofit.veslo.client.response.DualResponse");
        }
