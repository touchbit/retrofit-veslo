...
import org.touchbit.retrofit.veslo.client.TransportEvent;
...
import org.touchbit.retrofit.veslo.client.converter.defaults.JavaPrimitiveTypeConverter;
import org.touchbit.retrofit.veslo.client.converter.defaults.JavaReferenceTypeConverter;
import org.touchbit.retrofit.veslo.client.converter.defaults.RawBodyTypeConverter;
import org.touchbit.retrofit.veslo.client.header.ContentType;
import org.touchbit.retrofit.veslo.client.header.ContentTypeConstants;
...
public class ExtensionConverterFactoryUnitTests extends BaseCoreUnitTest {
    ...
    public void test1639065949524() {
        ...
        assertThat("", result, is("" +
                "Converter factory: class org.touchbit.retrofit.veslo.BaseCoreUnitTest$TestsExtensionConverterFactory" +
        ...
        public void test1639065949656() {
            ...
            assertThrow(() -> getTestFactory().getRequestConverterFromAnnotation(OBJ_C, AA, annotations, RTF))
                    ...
                    .assertMessageIs("API method contains concurrent annotations.\n" +
                            "Use only one of:\n" +
                            " * interface org.touchbit.retrofit.veslo.client.converter.api.RequestConverter\n" +
                            " * interface org.touchbit.retrofit.veslo.client.converter.api.Converters");
        }
    ...
    public class GetResponseConverterFromAnnotationMethodTests {
        ...
        public void test1639065949364() {
            ...
            assertThrow(() -> getTestFactory().getResponseConverterFromAnnotation(OBJ_C, annotations, RTF))
                    ...
                    .assertMessageIs("API method contains concurrent annotations.\n" +
                            "Use only one of:\n" +
                            " * interface org.touchbit.retrofit.veslo.client.converter.api.ResponseConverter\n" +
                            " * interface org.touchbit.retrofit.veslo.client.converter.api.Converters");
        }
            ...
            assertThrow(() -> getTestFactory().newInstance(PrivateConstructorConverter.class))
                    ...
                    .assertCause(cause -> cause
                            ...
                            .assertMessageContains(
                                    "org.touchbit.retrofit.veslo.client.converter.ExtensionConverterFactory ",
