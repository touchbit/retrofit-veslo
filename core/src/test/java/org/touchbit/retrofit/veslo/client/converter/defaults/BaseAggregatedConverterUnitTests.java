...
import org.touchbit.retrofit.veslo.client.converter.typed.BooleanConverter;
import org.touchbit.retrofit.veslo.client.converter.typed.IntegerConverter;
import org.touchbit.retrofit.veslo.client.converter.typed.StringConverter;
        ...
        public void test1639680932478() {
            ...
            assertThrow(() -> converter.requestBodyConverter(Boolean.class, AA, AA, RTF))
                    ...
                    .assertMessageContains("Unsupported type for converter " +
                            "org.touchbit.retrofit.veslo.client.converter.defaults.BaseAggregatedConverterUnitTests$1\n" +
