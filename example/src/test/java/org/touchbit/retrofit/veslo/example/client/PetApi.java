...
public interface PetApi {
    ...
    ExampleCustomResponse<Pet, Status> addPet(@Body Object body);
    ...
    ExampleCustomResponse<Status, Status> deletePet(@Path("petId") Object petId);
    ...
    ExampleCustomResponse<List<Pet>, Status> findPetsByStatus(@Query("status") Object... status);
    ...
    ExampleCustomResponse<List<Pet>, Status> findPetsByTags(@Query("tags") List<String> tags);
    ...
    ExampleCustomResponse<Pet, Status> getPetById(@Path("petId") Object petId);
    ...
    ExampleCustomResponse<Status, Status> updatePet(@Body Pet body);
    ...
    ExampleCustomResponse<Status, Status> updatePetWithForm(@Path("petId") Long petId,
