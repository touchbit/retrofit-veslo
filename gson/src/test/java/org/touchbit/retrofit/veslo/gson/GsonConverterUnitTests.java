...
import org.touchbit.retrofit.veslo.client.converter.api.ExtensionConverter.RequestBodyConverter;
...
import org.touchbit.retrofit.veslo.gson.model.GsonDTO;
...
import static org.touchbit.retrofit.veslo.client.converter.api.ExtensionConverter.NULL_JSON_VALUE;
...
public class GsonConverterUnitTests {
    ...
    public void test1639065954656() {
        final Logger logger = LoggerFactory.getLogger(GsonConverterUnitTests.class);
        assertGsonDualConverterFactory(new GsonDualConverterFactory(logger), GsonConverter.class);
        assertGsonDualConverterFactory(new GsonDualConverterFactory(), GsonConverter.class);
        assertGsonDualConverterFactory(new GsonDualConverterFactory(new TestGsonConverter()), TestGsonConverter.class);
        assertThrow(() -> new GsonDualConverterFactory((Logger) null)).assertNPE("logger");
        assertThrow(() -> new GsonDualConverterFactory((ExtensionConverter<Object>) null)).assertNPE("converter");
    }
    ...
    private void assertGsonDualConverterFactory(GsonDualConverterFactory factory, Class<?> expectedConverter) {
    ...
    private static class TestGsonConverter extends GsonConverter {
