...
public class GsonConverterUnitTests extends BaseUnitTest {
    ...
    public void test1639065954656() {
        ...
        assertGsonDualConverterFactory(new GsonConverterFactory(logger), GsonConverter.class);
        assertGsonDualConverterFactory(new GsonConverterFactory(), GsonConverter.class);
        assertGsonDualConverterFactory(new GsonConverterFactory(new TestGsonConverter()), TestGsonConverter.class);
        assertThrow(() -> new GsonConverterFactory((Logger) null)).assertNPE("logger");
        assertThrow(() -> new GsonConverterFactory((ExtensionConverter<Object>) null)).assertNPE("converter");
    }
