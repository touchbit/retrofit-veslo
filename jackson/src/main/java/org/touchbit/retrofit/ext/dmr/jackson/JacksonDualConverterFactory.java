...
public class JacksonDualConverterFactory extends ExtensionConverterFactory {
    ...
    public JacksonDualConverterFactory() {
        ...
        addMimeRequestConverter(jacksonConverter, APP_JSON, APP_JSON_UTF8, TEXT_JSON, TEXT_JSON_UTF8);
        addMimeResponseConverter(jacksonConverter, APP_JSON, APP_JSON_UTF8, TEXT_JSON, TEXT_JSON_UTF8);
    }
