...
/**
 * Utility class for building an HTTP client with a built-in Jackson2 converter
 * <p>
 *
 * @author Oleg Shaburov (shaburov.o.a@gmail.com)
 * Created: 04.02.2022
 */
public class JacksonTestClient {

    /**
     * Builds an HTTP client with a built-in Jackson2 converter
     *
    ...
    public static <C> C build(final String baseUrl,
                              ...
                              final Class<C> cli) {
        return TestClient.build(baseUrl, interceptor, callAdapterFactory, new JacksonConverterFactory(), cli);
    }

    /**
     * Utility class. Forbidden instantiation.
     */
    private JacksonTestClient() {
